...
from packages.tools.runtime_profiles import get_runtime_profile
...
def test_apptainer_worker_command_prefers_absolute_python_bin() -> None:
    profile = get_runtime_profile("apptainer-medgemma")

    command = _worker_command(profile)

    assert command[0] == "/home/longz2/.conda/envs/qwen_vllm/bin/python"
